...
class GlobalWebExceptionHandler {
	companion object {
		...
		private const val ERROR_BAD_REQUEST_VIEW = "/error/400"
		private const val ERROR_UNAUTHORIZED_VIEW = "/error/401"
		private const val ERROR_FORBIDDEN_VIEW = "/error/403"
		private const val ERROR_NOT_FOUND_VIEW = "/error/404"
		private const val ERROR_INTERNAL_SERVER_VIEW = "/error/500"
	}
